    ...
    public void setImage(final String url, final ImageView view, WXImageQuality quality, final WXImageStrategy strategy) {
        WXSDKManager.getInstance().postOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                String ruleStr = "assets/dist/";
                if (url.contains(ruleStr)) {
                    LoadLocalImageUtil.getInstance().dispalyFromAssets(url.substring(url.indexOf(ruleStr)+ruleStr.length()), view);
                    return;
                }
