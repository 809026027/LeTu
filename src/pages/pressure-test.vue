<template>
  <div class="container">
    ...
    <weex-amap class="map" ref="map2017" :sdk-key="keys" :map-instance="map" :zoom="zoom" :center="pos">
      <weex-amap-marker v-for="point in pointArr" :key="point.position" :position="point.position" :title="point.title" :icon="point.icon" @click="markerClick"></weex-amap-marker>
    </weex-amap>
