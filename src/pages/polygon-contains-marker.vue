<template>
  <div class="container">
    ...
    <weex-amap class="map" ref="map2017" :sdk-key="keys" :zoom="zoom" :center="pos">
      <weex-amap-polygon ref="polygon2017" :path="path" fill-color="#2ecc71"></weex-amap-polygon>
...
<script>
  ...
  export default {
    ...
    methods: {
      test() {
        Amap.polygonContainsMarker(this.marker.position, this.$refs.polygon2017.ref, (res) => {
          this.handleRes(res);
        });
      },
      
      test2() {
        Amap.polygonContainsMarker(this.marker2.position, this.$refs.polygon2017.ref, (res) => {
          this.handleRes(res);
        });
      },
